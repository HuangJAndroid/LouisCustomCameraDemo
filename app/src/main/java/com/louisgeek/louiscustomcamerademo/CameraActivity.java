...
*/
    ...
    private synchronized void handleAndSaveBitmap(byte[] data) {
        ...
        final Bitmap b = Utils.Bytes2Bitmap(data);
...
//        if (cameraPosition == 1) {
        ...
        public void run() {
            ...
            groupBitmap = group.getDrawingCache();
            iv_show.setImageBitmap(groupBitmap);
            iv_show.setVisibility(View.INVISIBLE);
            filePath = saveImageFile(groupBitmap);
            Intent intent = new Intent(CameraActivity.this, PreviewActivity.class);
            intent.putExtra("filePath", filePath);
            CameraActivity.this.startActivity(intent);
            group.setDrawingCacheEnabled(false);
...
//                    rightBitmap = Utils.rotate(groupBitmap, 180);
//                    break;
//                case ScreenSwitchUtils.ORIENTATION_HEAD_IS_LEFT:
//                    rightBitmap = Utils.rotate(groupBitmap, 270);
//                    break;
//                case ScreenSwitchUtils.ORIENTATION_HEAD_IS_RIGHT:
//                    rightBitmap = Utils.rotate(groupBitmap, 90);
//                    break;
//            }
//        } else {
//            //前置摄像头
